...
namespace Entreprenly.WebServices.Shared.Infrastructure.Pipeline.Middleware.Components;

/// <summary>
///     Global exception handling middleware. Catches all unhandled exceptions and returns a
