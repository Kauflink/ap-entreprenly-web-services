...
namespace Entreprenly.WebServices.Migrations
{
    ...
    [Migration("20260616120000_AddSubscriptionContext")]
    public partial class AddSubscriptionContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_plan_monthly_price = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2,
                        nullable: false),
                    current_plan_annual_price = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2,
                        nullable: false),
                    current_plan_status = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    current_plan_status_label = table.Column<string>(type: "varchar(80)", maxLength: 80,
                        nullable: false),
                    current_plan_badge_label = table.Column<string>(type: "varchar(80)", maxLength: 80,
                        nullable: false),
                    ...
                    recommended_plan_monthly_price = table.Column<decimal>(type: "decimal(10,2)", precision: 10,
                        scale: 2, nullable: false),
                    recommended_plan_annual_price = table.Column<decimal>(type: "decimal(10,2)", precision: 10,
                        scale: 2, nullable: false),
                    recommended_plan_status = table.Column<string>(type: "varchar(40)", maxLength: 40,
                        nullable: false),
                    recommended_plan_status_label = table.Column<string>(type: "varchar(80)", maxLength: 80,
                        nullable: false),
                    recommended_plan_badge_label = table.Column<string>(type: "varchar(80)", maxLength: 80,
                        nullable: false),
                    ...
                    payment_method_action_label = table.Column<string>(type: "varchar(120)", maxLength: 120,
                        nullable: false),
                    ...
                    fiscal_data_action_label = table.Column<string>(type: "varchar(120)", maxLength: 120,
                        nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_subscription_activity", x => x.id);
                    table.ForeignKey(
                        name: "f_k_subscription_activity_subscriptions_subscription_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "f_k_subscription_current_plan_features_subscriptions_subscription_id",
                        column: x => x.subscription_id,
                        principalTable: "subscriptions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "f_k_subscription_recommended_plan_features_subscriptions_subscription_id",
                        column: x => x.subscription_id,
                        principalTable: "subscriptions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_subscription_activity_subscription_id",
        ...
        {
            migrationBuilder.DropTable(name: "subscription_activity");
            migrationBuilder.DropTable(name: "subscription_current_plan_features");
            migrationBuilder.DropTable(name: "subscription_limits");
            migrationBuilder.DropTable(name: "subscription_payment_methods");
            migrationBuilder.DropTable(name: "subscription_recommended_plan_features");
